...
var decodeChunkedTransferEncoding = require("./decodeChunkedTransferEncoding");
var zlib;
...
Message.prototype.populateFromObject = function(obj) {
  var unsupportedPropertyNames = Object.keys(obj).filter(function(
    propertyName
  ) {
...
Message.prototype.populateFromString = function(str) {
  var bodyStartIndex = this.headers.populateFromStringAndReturnBodyStartIndex(
    str
  );
  ...
  get: function() {
    if (!isDefined(this._decodedBody)) {
      if (isDefined(this._rawBody) || isDefined(this._unchunkedBody)) {
        ...
        var contentTransferEncoding = this.headers.get(
          "Content-Transfer-Encoding"
        );
        var contentTransferEncodingIsHonored = !contentTransferEncoding;
        if (contentTransferEncoding) {
          ...
          if (contentTransferEncoding === "quoted-printable") {
            ...
            var qpDecodedBodyAsByteString = quotedPrintable.decode(
              this._decodedBody
            );
