...
Message.prototype.satisfies = function (spec, mustBeExhaustive) {
    ...
    if ('body' in spec) {
        ...
        if (typeof thisBody !== 'undefined') {
            ...
            if (isNonBufferObject(thisBody) && /^application\/json\b/i.test(this.headers.get('Content-Type')) && (typeof specBody === 'string' || Buffer.isBuffer(specBody))) {
                var parsedSpecBody;
                try {
            ...
            if (Buffer.isBuffer(thisBody) && (typeof specBody === 'string' || isNonBufferObject(specBody)) || (typeof specBody === 'undefined' && bufferCanBeInterpretedAsUtf8(thisBody) && isTextualContentType(this.headers.get('Content-Type')))) {
                try {
            ...
            if (/^application\/json\b/i.test(this.headers.get('Content-Type')) && typeof thisBody === 'string' && (typeof specBody === 'undefined' || isNonBufferObject(specBody))) {
                try {
        ...
        } else if (isNonBufferObject(specBody) && isNonBufferObject(thisBody)) {
